    ...
    if n_clicks:
        ...
        if time_dim and area_dim and platform_dim and software_dim:
            ...
            if rank_dim_cnt == 1 or rank_dim_cnt == 2:
                ...
                if rank_dim_cnt == 1:
                    rank_1, query_data1 = query_data.groupby(rank_dim[0])
                    rank_fig_output.add_trace(go.Bar(x=rank_1, y=query_data1['AoD']))
                ...
                threshold_base = query_data['AoD'].max() - query_data['AoD'].min()
                # print(threshold_base)
                threshold_tmp = query_data['AoD'].min()
                # print(threshold_tmp)
                threshold_list = [threshold_tmp + threshold_base * i for i in range(1, 4)]
                ...
                for rank_2, threshold_data2 in threshold_df.groupby('id'):
                    rank_fig_output.add_trace(go.Scatter(x=threshold_data2[rank_dim[0]], y=threshold_data2['v'] / 4,
